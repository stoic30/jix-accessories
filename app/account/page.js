    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-[430px] mx-auto px-4 py-6">
        ...
        <div className="space-y-2">
          ...
          <a href={`https://wa.me/2349153048279?text=Hi, I need support on`}  target="_blank" className="block bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition flex items-center justify-between">
            <div className="flex items-center">
