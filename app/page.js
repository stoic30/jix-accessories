...
export default async function Home() {
    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      <div className="max-w-[430px] mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-1">
          <p className="text-base font-semibold">⚡ Hot Deals & New Arrivals</p>
          <p className="text-sm opacity-90 mt-1">Limited time offers on premium gadgets</p>
        </div>
  ...
  <div className="flex justify-center gap-4 max-w-xs mx-auto">
    <a href="/category/phones" className="flex-shrink-0 text-center">
      <div className="w-30 h-30 rounded-2xl mb-2 overflow-hidden shadow-md transform hover:scale-105 transition">
        <img 
   ...
   <div className="px-4 py-5 mt-2 bg-white">
          ...
          <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2 -mx-1 px-1">
            {products.slice(0, 8).map(product => (
              <a key={product.id} href={`/product/${product.id}`} className="flex-shrink-0 text-center">
                ...
                <p className="text-sm font-bold text-gray-900 mt-1">₦{(product.price / 1000).toFixed(0)}k</p>
              </a>
            ))}
          </div>
        </div>
        ...
        <div className="mx-4 mt-2">
            ...
            className="block bg-gradient-to-r from-green-500 to-green-600 text-white p-5 rounded-2xl shadow-md hover:shadow-lg transition"
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base font-semibold mb-1">Need Help Choosing?</p>
